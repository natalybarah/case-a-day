...
const Discover= ()=>{
    ...
    const isNew= true;
    return(
        <div className="bg-linear-[180deg,#0B1020_0%,#121733_100%] max-w-[430px]  h-dvh flex flex-col gap-3 p-4 xs:pt-4 pt-2
         ">
            <div className="pb-0">
            ...
            <div>
                <h2 className="font-semibold font-fraunces text-[18px]  text-text-brand-emphasis  xs:mb-6  mb-3 ">Attorneys</h2>
